...
const Type0x000Style0x000 = (props) => {
  const Index0x000Style0x000 = React.useMemo(() => {
    ...
    meth.position.x = props.position.column * 2 - (props.dimension.column - 1) * 2 / 2
    meth.position.y = 1
    meth.position.z = props.position.row * 2 - (props.dimension.row - 1) * 2 / 2
  ...
  const Index0x000Style0x001 = React.useMemo(() => {
    ...
    line.position.x = props.position.column * 2 - (props.dimension.column - 1) * 2 / 2
    line.position.y = 1
    line.position.z = props.position.row * 2 - (props.dimension.row - 1) * 2 / 2
...
const Type0x001Style0x000 = (props) => {
  ...
  const Index0x010Style0x000 = React.useMemo(() => {
    ...
    pointLight.position.x = props.position.column * 2 - (props.dimension.column - 1) * 2 / 2
    pointLight.position.y = 3
    pointLight.position.z = props.position.row * 2 - (props.dimension.row - 1) * 2 / 2
