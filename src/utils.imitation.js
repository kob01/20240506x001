...
Imitation.prototype.setState = function setState(v) {
  this.state = typeof v === 'function' ? v(this.state) : v
  this.dispatch()
}
Imitation.prototype.assignState = function assignState(v) {
  this.state = Object.assign(this.state, typeof v === 'function' ? v(this.state) : v)
  this.dispatch()
}
Imitation.prototype.register = function register(...props) {
  return this.MonitorInstance.register(...props)
}
Imitation.prototype.dispatch = function dispatch(...props) {
